...
function generateAltText(data, confidence) {
  var ret = '';
  if (confidence >= 0.40) ret = data;else if (confidence < 0.4 && confidence >= 0.2) ret = "It probability is " + data;else if (confidence < 0.2 && confidence >= 0.1) ret = "It likely is " + data;else ret = "Image cannot be recogenized.";
  console.log(ret);
  return ret;
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1b74603c52a75db547c0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=contentScript.b3539b311fd7bd7b9ebc.hot-update.js.map