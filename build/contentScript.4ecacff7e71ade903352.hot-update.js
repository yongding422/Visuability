...
function generateAltText(data, confidence) {
  var ret = '';
  if (confidence > 0.40) ret = data;else if (confidence < 0.4 && confidence > 0.2) ret = "It is probability " + data;else if (confidence < 0.4 && confidence > 0.2) ret = "It is likely " + data;else ret = "Image cannot be recogenized.";
  console.log(ret);
  return ret;
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7cc364686f03b815bd4e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=contentScript.4ecacff7e71ade903352.hot-update.js.map